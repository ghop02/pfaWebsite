...
<head>
	<title><?php if ( is_category() ) {
		echo __('Category Archive for &quot;', 'theme1763'); single_cat_title(); echo __('&quot; | ', 'theme1763'); bloginfo( 'name' );
	} elseif ( is_tag() ) {
		echo __('Tag Archive for &quot;', 'theme1763'); single_tag_title(); echo __('&quot; | ', 'theme1763'); bloginfo( 'name' );
	} elseif ( is_archive() ) {
		wp_title(''); echo __(' Archive | ', 'theme1763'); bloginfo( 'name' );
	} elseif ( is_search() ) {
		echo __('Search for &quot;', 'theme1763').wp_specialchars($s).__('&quot; | ', 'theme1763'); bloginfo( 'name' );
	} elseif ( is_home() || is_front_page()) {
		bloginfo( 'name' ); echo ' | '; bloginfo( 'description' );
	}  elseif ( is_404() ) {
		echo __('Error 404 Not Found | ', 'theme1763'); bloginfo( 'name' );
	} elseif ( is_single() ) {
		wp_title('');
	} else {
  ...
  <link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_url' ); ?>/css/skeleton.css" />
	<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_url' ); ?>/css/camera.css" />
