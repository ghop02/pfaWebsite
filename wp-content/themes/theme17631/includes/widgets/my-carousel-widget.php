...
class MY_CarouselWidget extends WP_Widget {
							...
							<div id="carousel" class="es-carousel-wrapper">
								<div class="es-carousel">
									<ul>
										...
										<?php } ?>
											<a href="<?php the_permalink() ?>" class="link"><?php _e('Read more', 'theme1763'); ?></a>
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Limit Text:', 'theme1763'); ?> <input class="widefat" id="<?php echo $this->get_field_id('limit'); ?>" name="<?php echo $this->get_field_name('limit'); ?>" type="text" value="<?php echo $limit; ?>" /></label></p>
      ...
      <p><label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Post type:', 'theme1763'); ?><br />
