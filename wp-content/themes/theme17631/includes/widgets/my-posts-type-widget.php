    ...
    <?php if ($instance['posttype'] == "testi") {
      ...
      <?php }?>
            ...
            <?php if ( $instance['show_title'] ) : ?>
			  <?php echo $instance["before_post_title"]; ?><h6><a class="post-title" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php if ( $instance['show_title_date'] ) {?>[<?php the_time('m-d-Y'); ?>]<?php }else{?><?php the_title(); ?><?php }?></a></h6><?php echo $instance["after_post_title"]; ?>
			<?php endif; ?>
