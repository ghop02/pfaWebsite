...
function my_script() {
	if (!is_admin()) {
		...
		wp_enqueue_script('camera', get_bloginfo('template_url').'/js/camera.min.js', array('jquery'), '1.3.4');
		...
		wp_enqueue_script('BlackAndWhite', get_bloginfo('template_url').'/js/jQuery.BlackAndWhite.min.js', array('jquery'), '0.2.3');
